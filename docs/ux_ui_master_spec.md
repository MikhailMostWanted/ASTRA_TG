...
- Inline-кнопки:
  ...
  - `Следующий шаг`
  - `Домой`
- Следующий шаг: первый `[не готово]` пункт.
- Пустое состояние: список почти полностью `[не готово]`, но структура пути уже видна.
- Рабочее состояние: максимум `[готово]`, фокус на 1-2 последних недостающих слоях.
- Warning/error состояние:
