...
BOT_COMMAND_SPECS: tuple[BotCommandSpec, ...] = (
    ...
    BotCommandSpec("fullaccess_status", "Статус experimental full-access слоя"),
    BotCommandSpec("fullaccess_login", "Запросить или завершить user-auth full-access"),
    BotCommandSpec("fullaccess_logout", "Локально сбросить user-session full-access"),
    BotCommandSpec("fullaccess_chats", "Показать доступные user-чаты full-access"),
    BotCommandSpec("fullaccess_sync", "Ручной sync истории одного user-чата"),
